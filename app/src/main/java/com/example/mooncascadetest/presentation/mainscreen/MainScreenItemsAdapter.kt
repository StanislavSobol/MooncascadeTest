    ...
    inner class Holder(private val binding: ViewBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        private fun bindCurrentDateItem(item: DayForecastMainScreenListItem, binding: ItemForecastBinding) {
            with(binding) {
                ...
                dayMinTempWordsTextView.setTextWithVisibility(text = item.dayMinTempWords, underlined = true)
                dayMaxTempWordsTextView.setTextWithVisibility(text = item.dayMaxTempWords, underlined = true)
                ...
                nightMinTempWordsTextView.setTextWithVisibility(text = item.dayMinTempWords, underlined = true)
                nightMaxTempWordsTextView.setTextWithVisibility(text = item.dayMaxTempWords, underlined = true)
