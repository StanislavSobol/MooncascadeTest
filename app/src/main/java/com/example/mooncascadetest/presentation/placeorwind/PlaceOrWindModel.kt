...
data class PlaceOrWindModel(
    ...
    companion object {
        ...
        fun fromPlaceEntity(placeEntity: PlaceEntity, resourceManager: ResourceManager) = PlaceOrWindModel(
            isPlace = true,
        ...
        fun fromWindEntity(wiindEntity: WindEntity, resourceManager: ResourceManager) = PlaceOrWindModel(
            isPlace = false,
